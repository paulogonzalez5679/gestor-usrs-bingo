        ...
        <table className="w-full">
          <thead className="bg-gray-50 dark:bg-gray-800">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500">Paralelo</th>
                ...
                return (
                  <tr key={carton._id}>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
                      {participante.nivelCurso || "—"}
                    </td>

                    {/* Paralelo */}
                    <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
                      {participante.paralelo || "—"}
                    </td>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
                      {carton.timestamp
                        ? new Date(carton.timestamp * 1000).toLocaleDateString()
                        : "-"}
                    </td>
                    ...
                    <td className="px-6 py-4 text-sm">
                      <span
                        className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-xs font-medium ${carton.won
